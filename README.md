...
- Support for DNS-over-QUIC (doq-i00, [draft-ietf-dprive-dnsoquic-00](https://tools.ietf.org/id/draft-ietf-dprive-dnsoquic-00.txt)), client and server
...
Support for the QUIC protocol is still experimental. In the context of DNS, there are two implementations, DNS-over-QUIC ([draft-ietf-dprive-dnsoquic-00](https://tools.ietf.org/id/draft-ietf-dprive-dnsoquic-00.txt)) as well as DNS-over-HTTPS using QUIC. Both protocols are supported by RouteDNS, client and server implementations.
